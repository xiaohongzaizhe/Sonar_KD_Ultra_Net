...
def make_parser():
    parser = argparse.ArgumentParser("YOLOX ONNXRuntime inference")
    parser.add_argument(
        "--onnx",
        default="YOLOX_outputs/yolox_nano_conv_mix_all_resume/epoch_91_conv_mix.onnx",
    ...
    parser.add_argument(
        "--output-dir",
        default="YOLOX_outputs/onnxruntime_vis",
